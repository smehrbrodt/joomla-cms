...
ALTER TABLE `#__modules_menu` ADD COLUMN `include_submenus` BIT(1) NOT NULL DEFAULT 0 COMMENT 'Whether to show this module also on the submenus of the given menuid';